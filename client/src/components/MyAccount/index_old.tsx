          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 mb-8">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
              <div className="relative group">
                <div className="max-w-[100px] w-full h-[100px] rounded-full overflow-hidden ring-4 ring-blue-100">
                  <Image
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-dark-5 mb-4">Thành viên từ Tháng 9, 2020</p>
            ...
            <div className="xl:max-w-[370px] w-full">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="p-6 bg-gradient-to-br from-blue to-blue-dark">
                  ...
                  <p className="text-blue-100 text-sm">Quản lý tài khoản và đơn hàng của bạn</p>
                </div>
                ...
                <div className="p-4">
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className={`flex items-center rounded-xl gap-3 py-3.5 px-4 ease-out duration-200 hover:bg-blue hover:text-white group ${
                        activeTab === "dashboard"
                          ? "text-white bg-gradient-to-r from-blue to-blue-dark shadow-md"
                          : "text-dark-2 bg-gray-50 hover:bg-blue"
                      }`}
                    >
                      <svg
